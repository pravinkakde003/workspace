...
import com.example.findgo.Utils.Client;
import com.example.findgo.Utils.CustomProgressDialog;
import com.example.findgo.Utils.ProcessingSettings;
import com.example.findgo.Utils.Task;
...
public class AsyncProcessTask extends AsyncTask<String, String, Boolean> {
	...
	public AsyncProcessTask(ResultsActivity activity) {
		...
		dialog = new CustomProgressDialog(activity,"Processing");
	}
